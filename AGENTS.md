...
- Optional shipped walkshed data: `public/data/walksheds-{train,tram,bus}.json`, generated by `scripts/build-walksheds.ts` and loaded lazily by stop type
...
- Rebuild optional shipped default polygons with:
